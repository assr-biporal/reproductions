...
void _run_Pyramidal_Cells_resetter_codeobject()
{
...
const size_t _numv = 800;
 ...
 double* __restrict  _ptr_array_Pyramidal_Cells_v = _array_Pyramidal_Cells_v;
	...
	const int32_t *_events = _ptr_array_Pyramidal_Cells__spikespace;
	const int32_t _num_events = _ptr_array_Pyramidal_Cells__spikespace[800];
