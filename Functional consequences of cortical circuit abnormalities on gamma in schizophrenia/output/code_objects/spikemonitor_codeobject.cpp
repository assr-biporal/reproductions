...
const size_t _num_source_i = 800;
...
const size_t _numcount = 800;
const size_t _num_source_t = 1;
const size_t _num_source_idx = 800;
	///// POINTERS ////////////
 ...
 int32_t* __restrict  _ptr_array_Pyramidal_Cells_i = _array_Pyramidal_Cells_i;
 ...
 int32_t* __restrict  _ptr_array_spikemonitor__source_idx = _array_spikemonitor__source_idx;
	...
	int32_t _num_events = _ptr_array_Pyramidal_Cells__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_Pyramidal_Cells__spikespace[_j];
            if (_idx >= 0) {
                _start_idx = _j;
                break;
            }
        ...
        if (_num_events > 0) {
            ...
            {
                const size_t _idx = _ptr_array_Pyramidal_Cells__spikespace[_j];
                const size_t _vectorisation_idx = _idx;
                                
                const int32_t _source_i = _ptr_array_Pyramidal_Cells_i[_idx];
