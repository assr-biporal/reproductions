...
void _run_Pyramidal_Cells_stateupdater_codeobject()
{
...
const size_t _numg_AMPA_d = 800;
 ...
 const double _lio_15 = - (- 0.07);
	...
	for(int _idx=0; _idx<_N; _idx++)
	{
        ...
        double g_AMPA_r = _ptr_array_Pyramidal_Cells_g_AMPA_r[_idx];
        double g_NMDA_d = _ptr_array_Pyramidal_Cells_g_NMDA_d[_idx];
        double g_GABA_r = _ptr_array_Pyramidal_Cells_g_GABA_r[_idx];
        double v = _ptr_array_Pyramidal_Cells_v[_idx];
        double g_GABA_d = _ptr_array_Pyramidal_Cells_g_GABA_d[_idx];
        double g_AMPA_d = _ptr_array_Pyramidal_Cells_g_AMPA_d[_idx];
        double g_NMDA_r = _ptr_array_Pyramidal_Cells_g_NMDA_r[_idx];
        ...
        g_NMDA_r = _g_NMDA_r;
        v = _v;
        _ptr_array_Pyramidal_Cells_g_AMPA_r[_idx] = g_AMPA_r;
        _ptr_array_Pyramidal_Cells_g_NMDA_d[_idx] = g_NMDA_d;
        _ptr_array_Pyramidal_Cells_g_GABA_r[_idx] = g_GABA_r;
        _ptr_array_Pyramidal_Cells_v[_idx] = v;
        _ptr_array_Pyramidal_Cells_g_GABA_d[_idx] = g_GABA_d;
        _ptr_array_Pyramidal_Cells_g_AMPA_d[_idx] = g_AMPA_d;
        _ptr_array_Pyramidal_Cells_g_NMDA_r[_idx] = g_NMDA_r;
