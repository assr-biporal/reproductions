...
const size_t _num_source_idx = 50;
 ...
 int32_t* __restrict  _ptr_array_Fast_Spiking_Interneurons_i = _array_Fast_Spiking_Interneurons_i;
 double* __restrict  _ptr_array_spikemonitor_2_t = _array_spikemonitor_2_t;
 int32_t* __restrict  _ptr_array_Fast_Spiking_Interneurons__spikespace = _array_Fast_Spiking_Interneurons__spikespace;
 ...
 int32_t* __restrict  _ptr_array_spikemonitor_2__source_idx = _array_spikemonitor_2__source_idx;
	...
	int32_t _num_events = _ptr_array_Fast_Spiking_Interneurons__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_Fast_Spiking_Interneurons__spikespace[_j];
            if (_idx >= 0) {
                _start_idx = _j;
                break;
            }
        ...
        if (_num_events > 0) {
            ...
            {
                const size_t _idx = _ptr_array_Fast_Spiking_Interneurons__spikespace[_j];
                const size_t _vectorisation_idx = _idx;
                                
                const int32_t _source_i = _ptr_array_Fast_Spiking_Interneurons_i[_idx];
