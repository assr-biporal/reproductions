...
void _run_AMPA_NMDA_fromPCtoPC_pre_push_spikes()
{
    ...
    #pragma omp parallel
    {
        AMPA_NMDA_fromPCtoPC_pre.advance();
        AMPA_NMDA_fromPCtoPC_pre.push(_ptr_array_Pyramidal_Cells__spikespace, _ptr_array_Pyramidal_Cells__spikespace[_num_spikespace-1]);
    }
