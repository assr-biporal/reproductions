...
void _run_Regular_Spiking_Interneurons_resetter_codeobject()
{
...
const size_t _numv = 150;
 ...
 double* __restrict  _ptr_array_Regular_Spiking_Interneurons_v = _array_Regular_Spiking_Interneurons_v;
	...
	const int32_t *_events = _ptr_array_Regular_Spiking_Interneurons__spikespace;
	const int32_t _num_events = _ptr_array_Regular_Spiking_Interneurons__spikespace[150];
